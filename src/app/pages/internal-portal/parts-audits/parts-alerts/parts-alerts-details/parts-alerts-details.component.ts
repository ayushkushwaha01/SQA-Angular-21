...
@Component({
  standalone: false,
  selector: 'app-parts-alerts-details',
  templateUrl: './parts-alerts-details.component.html',
  styleUrls: ['./parts-alerts-details.component.scss']
})
export class PartsAlertsDetailsComponent implements OnInit {
